...
const Items = () => {
    ...
    const generateExcelReport = async () => {
      try {
        ...
        const worksheet = workbook.addWorksheet(`Items Report ${dateStr}`)
        ...
        titleRow.height = 30
        titleRow.getCell(1).value = 'ITEMS REPORT'
        ...
        const excelData = items.map(item => ({
          ...
          'Updated At': new Date(item.updatedAt).toLocaleString('en-US', {
            year: 'numeric',
            month: '2-digit',
            day: '2-digit',
            hour: '2-digit',
        ...
        // 生成带时间戳的文件名
        const fileName = `Items_Report_${dateStr}_${timeStr}.xlsx`
