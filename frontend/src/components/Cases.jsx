import { Button, Label, TextInput, Spinner, Alert, Table, TableHead, TableRow, TableHeadCell, TableBody, TableCell, Pagination, Badge, Card, Modal, ModalHeader, ModalBody, ModalFooter } from 'flowbite-react'
...
useEffect(() => {
    ...
    const generateExcelReport = async () => {
      try {
        ...
        let worksheetName = `${dataType === 'cost' ? 'Cases Cost' : 'Cases Count'} ${displayYear}`;
